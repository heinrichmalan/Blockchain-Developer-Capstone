...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(
            msg.sender == _owner,
            "Actor has to be the owner of the contract"
        );
        _;
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        require(newOwner != address(0), "New owner must have a valid address");
        _owner = newOwner;
...
contract ERC721 is Pausable, ERC165 {
    ...
    function approve(address to, uint256 tokenId) public {
        ...
        require(
            ...
            "Token owner cannot approve transfer to self"
        );
        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        address owner = _tokenOwner[tokenId];
        require(
            msg.sender == getOwner() || isApprovedForAll(owner, msg.sender)
        );
    ...
    function _mint(address to, uint256 tokenId) internal {
        // TODO revert if given tokenId already exists or given address is invalid - should fail if it's an invalid address, no?
        // https://stackoverflow.com/questions/63661630/how-to-check-if-ethereum-address-is-valid-in-solidity
        require(
            !_exists(tokenId) && to != address(0),
    ...
    function _transferFrom(
        ...
        require(
            ...
            "Transferer must be the owner of the token"
        );
...
contract ERC721Metadata is ERC721Enumerable, usingOraclize {
    ...
    function setTokenURI(uint256 tokenId) internal {
        require(_exists(tokenId), "Token must already exist to set the URI");
